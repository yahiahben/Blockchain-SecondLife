    ...
    try {
        if (typeof window.ethereum !== 'undefined') {
            ...
            document.getElementById('getArticlesAchetesBtn').addEventListener('click', async (event) => {
                ...
                // Utilise une fonction utilitaire pour récupérer les articles achetés
...
// Fonction utilitaire pour récupérer les articles achetés
async function getArticlesAchetesDetails(contract, account) {
    try {
        // Vérifie que le contrat possède une fonction pour récupérer les articles achetés
